...
An older proof-complete function-model version is preserved unchanged under the
hidden archive path:

- `.version/proof_complete_function_model_20260428/`

For maintenance, start from `Pyth/`; do not revive the weaker top-level
function-model skeleton unless explicitly comparing against the archive.
